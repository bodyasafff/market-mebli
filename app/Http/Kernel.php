...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'check.user.roles' => \App\Http\Middleware\CheckUserRoles::class,
        ...
        'remove.public.from.url' => \App\Http\Middleware\RemovePublicFromUrl::class,
        'remove.page1.from.url' => \App\Http\Middleware\RemovePage1FromUrl::class,
