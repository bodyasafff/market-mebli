 ...
 * Generated for Laravel 6.5.0 on 2019-12-02 18:36:03.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class App {
         ...
         * @static 
         */ 
        public static function routeWebIndex($model, $page = null, $getOnlyParams = false)
        {
                        return \App\Application::routeWebIndex($model, $page, $getOnlyParams);
        }
         ...
         * @static 
         */ 
        public static function routeBack($model = null)
        {
                        return \App\Application::routeBack($model);
        }
