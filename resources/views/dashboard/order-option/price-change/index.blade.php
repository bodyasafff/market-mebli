    ...
    <div class="mainTable mdl-grid">
        ...
        <div class="mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet mdl-cell--4-col-phone mdl-grid">
            <div class="mdl-cell mdl-cell--9-col mdl-cell--4-col-tablet mdl-cell--2-col-phone">
                <a href="{{route('dashboard.order_option.price_change.create') }}" class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent" style="margin-top: 10px;background-color: #8bc34a">Нова зміна ціни</a>
            </div>
    ...
    <script>
        $(function () {
            ...
            dataTable = $('#data-table').DataTable({
                ajax: {
                    url: '{{ route('dashboard.order_option.price_change.indexJson') }}',
                    type: 'post'
                },
                order: [
                    [1, "desc"],
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            return '<button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" onclick="location.href = \'/dashboard/order-option/price-change/' + row.id + '/edit\'">&nbsp;&nbsp;Редагувати&nbsp;&nbsp;</button>';
                        },
                    },
                    {
                        data: null,
        ...
        function deleteProductCategory(rowId) {
            if(confirm('Видалити?')){
                location.href = '/dashboard/order-option/price-change/'+rowId+'/destroy'
            }
        }
    </script>
