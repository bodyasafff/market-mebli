    ...
    <div class="mainTable mdl-grid">
        <div class="mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet mdl-cell--4-col-phone mdl-grid">
            <div class="mdl-cell mdl-cell--9-col mdl-cell--4-col-tablet mdl-cell--2-col-phone">
                <a href="{{route('dashboard.client.create') }}" class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent" style="margin-top: 10px;background-color: #8bc34a">Новий клієнт</a>
            </div>
...
@push('js')
    <script>
        ...
        $(document).ready(function() {
            // $('#data-table').on('click', 'td:first-child', function (event) {
            //     location.href = '/dashboard/client/'+this.textContent+'/detail'
            // });
            $('#data-table').on('dblclick','tr',function (event) {
                 location.href = '/dashboard/client/'+$(this).children('td').slice(0, 1).text()+'/detail'
            });
        });
        ...
        $(function () {
            ...
            dataTable = $('#data-table').DataTable({
                ajax: {
                    url: '{{ route('dashboard.client.indexJson') }}',
                    type: 'post'
                },
                order: [
                    [1, "desc"],
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            return '<button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" onclick="location.href = \'/dashboard/client/' + row.id + '/edit\'">&nbsp;&nbsp;Редагувати&nbsp;&nbsp;</button>';
                        },
                    },
                    {
                        data: null,
